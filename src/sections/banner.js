      ...
      <Container sx={styles.banner.container}>
        <Box sx={styles.banner.contentBox}>
          ...
          <Text as="p" variant="heroSecondary">
            Duke Token is a decentralized meme token to incentivize the crypto space. Duke is not a Duge coin killer, unlike other Shib inu tokens. Duke tokens is a community driven project like duge coin to increase crypto adoptions.  Duke Token is just a joke, it was created for fun sake don't buy it for investment purposes. 
          </Text>
